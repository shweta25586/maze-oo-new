...
function createQRCodeLabyrinth(nameOfYourGirlFriend, url) {
...
window.onload = function () {
    ...
    $("#dialog-form").dialog({
        ...
        buttons: {
            "Create": function () {
                //Creating scene
                lovescene = createQRCodeLabyrinth($("#name").val(), $("#url").val());
            ...
            "Login": function () {
                    ...
                    window.alert('Login failed, Reset password required');
                    //throw new Error("Wrong password, Login failed, Reset password required");
            }
        }
    });
